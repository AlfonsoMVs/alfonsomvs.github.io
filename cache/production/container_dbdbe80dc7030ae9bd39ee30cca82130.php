...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000053368151000000000f59889f(
...
class phpbbtemplatetwiglexer_0000000053368151000000000f59889f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5e02356705806380806383 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5e0235670580c400447016 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5e023567057f3362405572 = array(
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, 'set_environment', array('env' => $env), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        return $this->valueHolder5e02356705806380806383->set_environment($env);
    }
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        return $this->valueHolder5e02356705806380806383->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        return $this->valueHolder5e02356705806380806383->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5e0235670580c400447016 = $initializer;
    }
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__get', array('name' => $name), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        if (isset(self::$publicProperties5e023567057f3362405572[$name])) {
            return $this->valueHolder5e02356705806380806383->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5e02356705806380806383;
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__isset', array('name' => $name), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__unset', array('name' => $name), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;
    ...
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__clone', array(), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        $this->valueHolder5e02356705806380806383 = clone $this->valueHolder5e02356705806380806383;
    }

    public function __sleep()
    {
        $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, '__sleep', array(), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;

        return array('valueHolder5e02356705806380806383');
    }
    ...
    {
        return $this->initializer5e0235670580c400447016;
    }
    ...
    {
        return $this->initializer5e0235670580c400447016 && ($this->initializer5e0235670580c400447016->__invoke($valueHolder5e02356705806380806383, $this, 'initializeProxy', array(), $this->initializer5e0235670580c400447016) || 1) && $this->valueHolder5e02356705806380806383 = $valueHolder5e02356705806380806383;
    }
    ...
    {
        return null !== $this->valueHolder5e02356705806380806383;
    }
    ...
    {
        return $this->valueHolder5e02356705806380806383;
    }
