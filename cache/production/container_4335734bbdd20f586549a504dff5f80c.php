...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000515bd498000000003d507860(
...
class phpbbtemplatetwiglexer_00000000515bd498000000003d507860 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5e02356a289c5957863307 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5e02356a289ca659564496 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5e02356a289b1700170958 = array(
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, 'set_environment', array('env' => $env), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        return $this->valueHolder5e02356a289c5957863307->set_environment($env);
    }
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        return $this->valueHolder5e02356a289c5957863307->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        return $this->valueHolder5e02356a289c5957863307->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5e02356a289ca659564496 = $initializer;
    }
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__get', array('name' => $name), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        if (isset(self::$publicProperties5e02356a289b1700170958[$name])) {
            return $this->valueHolder5e02356a289c5957863307->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5e02356a289c5957863307;
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__isset', array('name' => $name), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__unset', array('name' => $name), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;
    ...
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__clone', array(), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        $this->valueHolder5e02356a289c5957863307 = clone $this->valueHolder5e02356a289c5957863307;
    }

    public function __sleep()
    {
        $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, '__sleep', array(), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;

        return array('valueHolder5e02356a289c5957863307');
    }
    ...
    {
        return $this->initializer5e02356a289ca659564496;
    }
    ...
    {
        return $this->initializer5e02356a289ca659564496 && ($this->initializer5e02356a289ca659564496->__invoke($valueHolder5e02356a289c5957863307, $this, 'initializeProxy', array(), $this->initializer5e02356a289ca659564496) || 1) && $this->valueHolder5e02356a289c5957863307 = $valueHolder5e02356a289c5957863307;
    }
    ...
    {
        return null !== $this->valueHolder5e02356a289c5957863307;
    }
    ...
    {
        return $this->valueHolder5e02356a289c5957863307;
    }
