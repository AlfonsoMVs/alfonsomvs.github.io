        ...
        <div class="leftside">
			<div class="sidebar">
				<div class="nav-profile">
					<div class="thumb">
						<img  src="<?php echo $user['cms_pprofile']; ?>" class="img-circle" alt="" />
					</div>
					<div class="info">
				...
				<div class="title">Navegaci&oacute;n</div>
					<ul class="nav-sidebar">
						...
						<li <?php if($zone == 'Header' || $zone == 'Sub Navegaci&oacute;n'){ echo 'class=" nav-dropdown active"'; }else{ echo 'class="nav-dropdown"'; } ?>>
							<a href="#">
								<i class="fa fa-bars"></i> <span>Header</span>
								<span class="label bg-green-700 pull-right">NUEVO</span>
							</a>
							<ul>
                                <li><a href="{HK}/header.php">Tabs</a></li>
                                <li><a href="{HK}/subnavi.php">Sub Navegaci&oacute;n</a></li>
                            </ul>
							
						</li>
						<li <?php if($zone == 'Addons'){ echo 'class="active"'; }else{ echo 'class="desactive"'; } ?>>
							<a href="{HK}/addons.php">
                       ...
                       <li <?php if($zone == 'Noticiones' || $zone == 'Promos'){ echo 'class=" nav-dropdown active"'; }else{ echo 'class="nav-dropdown"'; } ?>>
							...
							<ul>
                                <li><a href="{HK}/news.php">Noticiones</a></li>
								...
								if($search->num_rows > 0){
									while($inform = $search->fetch_array()){?>
										<ul style="width:100%;margin-left:-20px;">
											<img src="<?php echo $inform['cms_pprofile']; ?>" alt="avatar" class="pull-left" />
