				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="panel bg-red-400">
						<div class="panel-body padding-15-20">
							<div class="clearfix">
								<div class="pull-left">
									<div class="color-white font-size-26 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="343" data-speed="500" data-refresh-interval="10"><?php echo $Functions->GetCount('users_bans'); ?></div>
					...
					<div class="panel">
						...
						<div class="panel-body" style="padding:10px;width:100%;">
							<p style="text-align:justify">
								...
								Bienvenido al nuevo Panel de Administraci&oacute;n de OneCMS. Este panel est&aacute; 
