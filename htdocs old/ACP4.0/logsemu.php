...
ob_start();
	...
	$TplClass->SetParam('title', 'Logs del Emulador');
	$TplClass->SetParam('zone', 'Logs del Emulador');
		...
		<body>
			<div class="row">
				<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
					<div class="panel border-1 border-grey-600">
						<div class="panel-title bg-grey-600">
							<div class="panel-head color-white"><i class="fa fa-tasks"></i> Logs del EMU</div>
						</div>
							...
							<div class="slimScrollDiv" style="position: relative; overflow: auto; width: auto; height:430px;">
								<table border="1" style="width:100%">
								  <tr>
									...
									<th style="width:15%;"><center>Acci&oacute;n</center></th> 
									<th style="width:15%;"><center>Hacia</center></th> 
									<th style="width:38.75%;"><center>Detalles</center></th>
									<th style="width:16.25%;"><center>Fecha</center></th>
								  </tr>
									<?php global $db;
										$busc = $db->query("SELECT * FROM server_stafflogs ORDER by id DESC");
										if($busc->num_rows > 0){
											while($info = $busc->fetch_array()){ ?>
												<tr>
													<td style="padding:5px;"><center><?php echo $info['staffuser']; ?></center></td>
													<td style="padding:5px;"><center><?php echo $info['action_type']; ?></center></td> 
													<td style="padding:5px;"><center><?php echo $info['target']; ?></center></td> 
													<td style="padding:5px;"><?php echo $info['description']; ?></td>
													<td><center>El <?php echo$info['time']; ?></center></td>
												</tr>
