		...
		if(empty($code) || empty($title) || empty($desc_b) || empty($nombrefoto1)){
			...
			if(is_uploaded_file($ruta1)){ 
				if($_FILES['foto1']['type'] == 'image/gif'){
					...
					$file = '../swf/gamedata/external_flash_texts/1.txt';//URL de tus external_flash_texts
					$fp = fopen($file, 'a');
					...
					<div class="panel border-1 border-blue-500">
						...
						<div class="panel-body">
							<form action="" method="post" enctype="multipart/form-data">
								...
								<input class="btn btn-dark bg-light-blue-300 color-white margin-left-10" name="foto1" type="file" id="foto1" >
