...
\ ♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛♛*/
	...
	$TplClass->SetParam('title', 'Comunidad');
	$Functions->Logged("true");
	$TplClass->SetParam('HKLINK', '');
	$h = $db->query("SELECT * FROM cms_header WHERE zone = 'Comunidad'");
	$head = $h->fetch_array();
	$TplClass->SetParam('TAB', $head['id']);
...
//COLUMNA CENTRO
	...
	$TplClass->AddTemplate("Data", "promos");
	$TplClass->AddTemplate("Data/Columnas", "column-custom");
//COLUMNA 1	
	$TplClass->Display("column-1");
	$TplClass->AddTemplate("Data", "rooms");
	$TplClass->AddTemplate("Data", "noticiones");
	$TplClass->AddTemplate("Data/Columnas", "column-1");
	$TplClass->DisplayClosed();
//COLUMNA 2
	$TplClass->Display("column-2");
	$TplClass->AddTemplate("Data", "topgroups");
	$TplClass->AddTemplate("Data", "tops");
