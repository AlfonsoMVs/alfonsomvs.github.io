	...
	class TplClass{
		...
		public function SetAll(){
			if($_SESSION['IS_LOGGED']){
				global $db;
				$users = $db->query("SELECT id, username, rank, look, motto, credits, activity_points, seasonal_currency, last_online, mail, account_created, cms_refers FROM users WHERE username = '{$_SESSION['username']}' AND password = '{$_SESSION['password']}'");
