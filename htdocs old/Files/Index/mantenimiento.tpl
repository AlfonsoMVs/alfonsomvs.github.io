<html>
	﻿﻿<head>
		...
		<title>{SHORTNAME} ~ ¡Mantenimiento Temporal!</title>
	...
	<body>
		...
		<div id="header-bottom"><div class="content2"><img src="{CDN}/images/index/header.png" style="margin-top:-75px;"><img src="{CDN}/images/index/sole.png" style="margin-top:-20%;margin-left:15%;"><img src="https://habblumers.files.wordpress.com/2014/07/mantenimiento.gif" style="margin-top:-150px;"></div></div>
		<!-- background: linear-gradient(transparent, rgba(0, 0, 0, 0.8)) -->
		<div class="content" style="margin-top:10px;">																																																																																																																																																																																																																																																																																																																																																																							
			<div id="error">Estamos en Mantenimiento. Regresamos en breve. Lamentamos las molestias.</div><br>
			...
			<div class="left" style="margin-top:40px;">
				...
				<form action="/submit.php" method="post" >
					...
					<input name="login" type="submit" id="register_button" style="margin-top:8px;height: 46px;float:left;width: 300px;" value="Administraci&oacute;n">																																																																																																																																																																										
					<a href="#" id="close_button" style="margin-top:8px;height:2.8%;float:left;width:120%;">Hotel Cerrado</a>
				</form>
			</div>
			...
			<div class="registerbanner">
				<img src="{CDN}/images/frankstop.gif" style="margin-top: 15px;float:left;margin-left: 120px;">
				<div id="sprechblase" style="width: auto;">Frank: ¡Estamos en Mantenimiento! Regresamos en breve.</div>
			</div></br>
